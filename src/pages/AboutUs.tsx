          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-foreground/70">
                <p>
                  {language === "en" 
                    ? "Founded in 2009, Citrine Clinic was born from a vision to create a sanctuary where medical excellence meets luxury hospitality."
                    : "تأسست عيادة سيترين في عام 2009، ولدت من رؤية لإنشاء ملاذ حيث يلتقي التميز الطبي بالضيافة الفاخرة."
                  }
                </p>
                <p>
                  {language === "en" 
